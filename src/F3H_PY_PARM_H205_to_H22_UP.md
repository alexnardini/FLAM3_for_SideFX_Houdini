...
#
#   Name:       F3H_PY_PARM_H205_to_H22_UP
#
...
def py_module_vars() -> str:
    ...
    * __module_filename__ -> module filename to use
    ...
    if h < 205:
        __module_filename__ = "py_flam3__3_7"
    elif h < 220:
        __module_filename__ = "py_flam3__3_11_H21"
    else:
        __module_filename__ = "py_flam3__3_13"
...
# <img width="48" height="48" src="../icons/icon_pythonSVG.svg" /> PythonModule `H21.0`
...
def py_module_vars() -> str:
    ...
    * __module_filename__ -> module filename to use
    ...
    if h < 205: 
        ...
        __module_filename__: str = "py_flam3__3_11_H21"
...
# <img width="48" height="48" src="../icons/icon_pythonSVG.svg" /> PreFirstCreate `H20.5 to H22.0 UP`
...
# <img width="48" height="48" src="../icons/icon_pythonSVG.svg" /> OnCreated `H20.5 to H22.0 UP`
...
# <img width="48" height="48" src="../icons/icon_pythonSVG.svg" /> OnLoaded `H20.5 to H22.0 UP`
...
# <img width="48" height="48" src="../icons/icon_pythonSVG.svg" /> OnDeleted `H20.5 to H22.0 UP`
...
- ### <img width="16" height="16" src="../icons/icon_actionButtonSVG.svg" /> Action Button Script
```python
kwargs['node'].hdaModule().flam3.flam3h_general_utils(kwargs).reset_parm((1024,))
```
...
| Tab | Parameter name | Parameter type |  Houdini version | FLAM3H™ version |
|:---|:---|---:|---:|---:|
| **PREFS** | `cullamount` |  `float` | `from H20.5` | `v1.x` `v2.x` |
...
- ### <img width="16" height="16" src="../icons/icon_callbackButtonSVG.svg" /> Callback Script
```python
hou.phm().flam3.flam3h_general_utils(kwargs).viewportParticleSize(), kwargs['parm'].deleteAllKeyframes()
```
- ### <img width="16" height="16" src="../icons/icon_actionButtonSVG.svg" /> Action Button Script
```python
...
- ### <img width="16" height="16" src="../icons/icon_callbackButtonSVG.svg" /> Callback Script
```python
hou.phm().flam3.flam3h_general_utils(kwargs).viewportWireWidth(), kwargs['parm'].deleteAllKeyframes()
```
- ### <img width="16" height="16" src="../icons/icon_actionButtonSVG.svg" /> Action Button Script
```python
