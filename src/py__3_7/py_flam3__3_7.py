...
* reset_IN(self, mode: int = 0) -> None:
    ...
    def in_to_flam3h_set_palette(self, node: hou.SopNode, apo_data: in_flame_iter_data, _FLAM3H_INIT_DATA: tuple[Union[str, None], bool, int, str, bool, bool], flashmessage: bool = False) -> None:
