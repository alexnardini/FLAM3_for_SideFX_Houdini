...
'''
    ...
    Comment:    Simple utility node to quickly setup
                ...
                Note:
                    ...
                    Please check the file: ../F3HUSD_PY_PARM_H19_to_H20.md
...
# FLASH MSG TIMER
FLAM3HUSD_FLASH_MESSAGE_TIMER: float = 2 # Note that for this FLAM3H™USD OTL the flash messages only run in netowrk editors belonging to the Lop context.
...
@STATICMETHODS
* set(node: hou.LopNode, _prm: Union[hou.Parm, hou.ParmTuple, str], data: Union[int, float, str, tuple, hou.Ramp, hou.Vector3, hou.Vector2], revertToDefaults: bool = False) -> None:
* setParms(node: hou.LopNode, parms_dict: dict, revertToDefaults: bool = False) -> None:
* private_prm_set(node: hou.LopNode, _prm: Union[str, hou.Parm], data: Union[int, float, str, tuple, hou.Ramp, hou.Vector3, hou.Vector2], revertToDefaults: bool = False) -> None:
* private_prm_deleteAllKeyframes(node: hou.LopNode, _prm: Union[str, hou.Parm], revertToDefaults: bool = False) -> None:
...
@METHODS
    ...
    @staticmethod
    def set(node: hou.LopNode, _prm: Union[hou.Parm, hou.ParmTuple, str], data: Union[int, float, str, tuple, hou.Ramp, hou.Vector3, hou.Vector2], revertToDefaults: bool = False) -> None:
    ...
    @staticmethod
    def private_prm_set(node: hou.LopNode, _prm: Union[str, hou.Parm], data: Union[int, float, str, tuple, hou.Ramp, hou.Vector3, hou.Vector2], revertToDefaults: bool = False) -> None:
    ...
    @staticmethod
    def private_prm_deleteAllKeyframes(node: hou.LopNode, _prm: Union[str, hou.Parm], revertToDefaults: bool = False) -> None:
...
* flam3husd_compatible(h_version: int, kwargs: Union[dict, None], msg: bool) -> bool:
...
* flam3h_on_deleted(self) -> None:
    ...
    @staticmethod
    def flam3husd_h_versions_build_data(__h_versions__: Union[tuple, int], last_index: bool = False) -> str:
    ...
    @staticmethod
    def flam3husd_compatible(h_version: int, kwargs: Union[dict, None], msg: bool) -> bool:
        ...
        * def flam3h_compatible_range_open(kwargs: Union[dict, None], msg: bool) -> bool:
        ...
        Args:
            ...
            kwargs(Union[dict, None]): When needed, this must be the class' self.kwargs. In the case of this definition, it will be passed in from the containing definition args. Or None
    ...
    @staticmethod
    def flam3husd_compatible_range_close(kwargs: Union[dict, None], msg: bool) -> bool:
        """Tell if this FLAM3H™USD version is compatible with this Houdini version
        
        * range_close -> mean FLAM3H™USD will run only on Houdini versions included inside: __h_versions__
        
        Args:
            kwargs(Union[dict, None]): When needed, this must be the class' self.kwargs, or None
            msg(bool): When False it will not run the hou display messages.
    ...
    @staticmethod
    def flam3husd_compatible_range_open(kwargs: Union[dict, None], msg: bool) -> bool:
        """Tell if this FLAM3H™USD version is compatible with this Houdini version
        
        * range_open -> mean it allow FLAM3H™USD to run on newer versions of Houdini than the versions included inside: __h_versions__ before being properly fine tuned.
    ...
    def flam3husd_compatible_type(self, range_type: bool, kwargs: Union[dict, None] = None, msg: bool = True) -> bool:
    ...
    def flam3husd_on_create(self) -> None:
        ...
        # Check if we are importing a valid FLAM3H™ node on all the of other FLAM3H™USD node instances
    ...
    def autoSetRenderer_on_create(self) -> None:
        ...
        if renderers:
            ...
            if _RND is not None:
                ...
                rnd_idx: Union[int, None] = flam3husd_general_utils.flam3husd_hydra_renderers_dict().get(_RND)
...
* util_getParameterEditors(nodeTypeCategory: str = F3H_NODE_TYPE_NAME_CATEGORY) -> list:
...
* flam3husd_display_help(self) -> None:
    ...
    @staticmethod
    def util_getParameterEditors(nodeTypeCategory: str = F3H_NODE_TYPE_NAME_CATEGORY) -> list:
        ...
        Args:
            (None):
            nodeTypeCategory(str): Default to: F3H_NODE_TYPE_NAME_CATEGORY (FLAM3H™). The node type category to check for in the parameter editors.
    ...
    def flash_message(msg: Union[str, None], timer: float = FLAM3HUSD_FLASH_MESSAGE_TIMER, img: Union[str, None] = None, usd_context: str = 'Lop') -> None:
        ...
        Args:
            ...
            timer(float): Default to: FLAM3H™USD_FLASH_MESSAGE_TIMER. How long the printed message stay before it fade away.
...
* flam3husd_web_run(self, key: str) -> None:
    ...
    def flam3husd_about_msg(self):
        ...
        build: tuple = (Implementation_build, 
                        )
