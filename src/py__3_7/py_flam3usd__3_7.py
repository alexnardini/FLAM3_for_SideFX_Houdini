...
* flam3h_on_deleted(self) -> None:
    ...
    def flam3husd_compatible_range_close(kwargs: Union[dict, None], msg: bool) -> bool:
        ...
        * range_close -> mean FLAM3H™USD will run only on Houdini versions included inside: nodetype.hdaModule().__h_versions__
        ...
        this_h_versions: tuple = nodetype.hdaModule().__h_versions__ # type: ignore # This is set inside each FLAM3H™USD HDA PythonModule module.
    ...
    def flam3husd_on_create_compatible_false(self) -> None:
        ...
        __h_versions__: tuple = nodetype.hdaModule().__h_versions__ # type: ignore # This is set inside each FLAM3H™USD HDA PythonModule module.
