...
int XAOS(int idx; const float XST[], res){
    ...
    if(res<12){
        ...
        if(res==12){
            ...
            else if(idx==8){ return sample_cdf((float[])XST[120:135], nrandom('twister')); }
            ...
            else if(idx==8){ return sample_cdf((float[])XST[128:144], nrandom('twister')); }
            ...
            else if(idx==9){ return sample_cdf((float[])XST[153:170], nrandom('twister')); }
            ...
            else if(idx==9){ return sample_cdf((float[])XST[162:180], nrandom('twister')); }
            ...
            else if(idx==10){ return sample_cdf((float[])XST[190:209], nrandom('twister')); }
            ...
            else if(idx==10){ return sample_cdf((float[])XST[200:220], nrandom('twister')); }
