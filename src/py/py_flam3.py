...
* iterator_vactive_and_update(self) -> None:
    ...
    def menu_global_density(self) -> list:
        ...
        """
        node = self.node
        if node.parm(PREFS_PVT_XF_VIZ).eval():
