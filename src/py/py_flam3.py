...
class flam3_varsPRM_FF:
    ...
    varsPRM_FF = (  FLAM3VARS.varsPRM[0], 
                    ...
                    [FLAM3VARS.varsPRM[27][0], [prx_FF + FLAM3VARS.varsPRM[27][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[28][0], [prx_FF + FLAM3VARS.varsPRM[28][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[29][0], [prx_FF + FLAM3VARS.varsPRM[29][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[30][0], [prx_FF + FLAM3VARS.varsPRM[30][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[31][0], [prx_FF + FLAM3VARS.varsPRM[31][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[32][0], [prx_FF + FLAM3VARS.varsPRM[32][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[33][0], 0], 
                    [FLAM3VARS.varsPRM[34][0], [prx_FF + FLAM3VARS.varsPRM[34][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[35][0], [prx_FF + FLAM3VARS.varsPRM[35][1][0][:-1], 0], 1], 
                    [FLAM3VARS.varsPRM[36][0], [prx_FF + FLAM3VARS.varsPRM[36][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[37][0], [prx_FF + FLAM3VARS.varsPRM[37][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[38][0], [prx_FF + FLAM3VARS.varsPRM[38][1][0][:-1], 1], 1], 
                    ...
                    [FLAM3VARS.varsPRM[47][0], [prx_FF + FLAM3VARS.varsPRM[47][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[48][0], [prx_FF + FLAM3VARS.varsPRM[48][1][0][:-1], 1], [prx_FF + FLAM3VARS.varsPRM[48][2][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[49][0], [prx_FF + FLAM3VARS.varsPRM[49][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[50][0], [prx_FF + FLAM3VARS.varsPRM[50][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[51][0], [prx_FF + FLAM3VARS.varsPRM[51][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[52][0], [prx_FF + FLAM3VARS.varsPRM[52][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[53][0], [prx_FF + FLAM3VARS.varsPRM[53][1][0][:-1], 0], 1],
                    [FLAM3VARS.varsPRM[54][0], 0],
                    [FLAM3VARS.varsPRM[55][0], 0], 
                    [FLAM3VARS.varsPRM[56][0], [prx_FF + FLAM3VARS.varsPRM[56][1][0][:-1], 0], 1], 
                    [FLAM3VARS.varsPRM[57][0], [prx_FF + FLAM3VARS.varsPRM[57][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[58][0], 0], 
                    [FLAM3VARS.varsPRM[59][0], 0], 
                    [FLAM3VARS.varsPRM[60][0], 0], 
                    [FLAM3VARS.varsPRM[61][0], [prx_FF + FLAM3VARS.varsPRM[61][1][0][:-1], 0], 1], 
                    [FLAM3VARS.varsPRM[62][0], 0], 
                    [FLAM3VARS.varsPRM[63][0], [prx_FF + FLAM3VARS.varsPRM[63][1][0][:-1], 1], [prx_FF + FLAM3VARS.varsPRM[63][2][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[64][0], 0], 
                    [FLAM3VARS.varsPRM[65][0], 0], 
                    [FLAM3VARS.varsPRM[66][0], [prx_FF + FLAM3VARS.varsPRM[66][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[67][0], [prx_FF + FLAM3VARS.varsPRM[67][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[68][0], 0], 
                    [FLAM3VARS.varsPRM[69][0], [prx_FF + FLAM3VARS.varsPRM[69][1][0][:-1], 1], [prx_FF + FLAM3VARS.varsPRM[69][2][0][:-1], 0], 1], 
                    [FLAM3VARS.varsPRM[70][0], 0], 
                    [FLAM3VARS.varsPRM[71][0], [prx_FF + FLAM3VARS.varsPRM[71][1][0][:-1], 1], [prx_FF + FLAM3VARS.varsPRM[71][2][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[72][0], [prx_FF + FLAM3VARS.varsPRM[72][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[73][0], [prx_FF + FLAM3VARS.varsPRM[73][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[74][0], [prx_FF + FLAM3VARS.varsPRM[74][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[75][0], [prx_FF + FLAM3VARS.varsPRM[75][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[76][0], [prx_FF + FLAM3VARS.varsPRM[76][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[77][0], [prx_FF + FLAM3VARS.varsPRM[77][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[78][0], [prx_FF + FLAM3VARS.varsPRM[78][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[79][0], [prx_FF + FLAM3VARS.varsPRM[79][1][0][:-1], 1], [prx_FF + FLAM3VARS.varsPRM[79][2][0][:-1], 1], 1], 
                    ...
                    [FLAM3VARS.varsPRM[94][0], [prx_FF + FLAM3VARS.varsPRM[94][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[95][0], [prx_FF + FLAM3VARS.varsPRM[95][1][0][:-1], 0], 1], 
                    [FLAM3VARS.varsPRM[96][0], [prx_FF + FLAM3VARS.varsPRM[96][1][0][:-1], 1], [prx_FF + FLAM3VARS.varsPRM[96][2][0][:-1], 1], 1],
                    [FLAM3VARS.varsPRM[97][0], [prx_FF + FLAM3VARS.varsPRM[97][1][0][:-1], 1], [prx_FF + FLAM3VARS.varsPRM[97][2][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[98][0], [prx_FF + FLAM3VARS.varsPRM[98][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[99][0], [prx_FF + FLAM3VARS.varsPRM[99][1][0][:-1], 1], [prx_FF + FLAM3VARS.varsPRM[99][2][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[100][0], 0], 
                    [FLAM3VARS.varsPRM[101][0], [prx_FF + FLAM3VARS.varsPRM[101][1][0][:-1], 1], [prx_FF + FLAM3VARS.varsPRM[101][2][0][:-1], 1], [prx_FF + FLAM3VARS.varsPRM[101][3][0][:-1], 1], 1] )


    varsPRM_FP = (  FLAM3VARS.varsPRM[0], 
                    FLAM3VARS.varsPRM[1], 
                    FLAM3VARS.varsPRM[2], 
                    FLAM3VARS.varsPRM[3], 
                    FLAM3VARS.varsPRM[4], 
                    ...
                    FLAM3VARS.varsPRM[25], 
                    FLAM3VARS.varsPRM[26], 
                    [FLAM3VARS.varsPRM[27][0], [prx_FP + FLAM3VARS.varsPRM[27][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[28][0], [prx_FP + FLAM3VARS.varsPRM[28][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[29][0], [prx_FP + FLAM3VARS.varsPRM[29][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[30][0], [prx_FP + FLAM3VARS.varsPRM[30][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[31][0], [prx_FP + FLAM3VARS.varsPRM[31][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[32][0], [prx_FP + FLAM3VARS.varsPRM[32][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[33][0], 0], 
                    [FLAM3VARS.varsPRM[34][0], [prx_FP + FLAM3VARS.varsPRM[34][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[35][0], [prx_FP + FLAM3VARS.varsPRM[35][1][0][:-1], 0], 1], 
                    [FLAM3VARS.varsPRM[36][0], [prx_FP + FLAM3VARS.varsPRM[36][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[37][0], [prx_FP + FLAM3VARS.varsPRM[37][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[38][0], [prx_FP + FLAM3VARS.varsPRM[38][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[39][0], 0], 
                    [FLAM3VARS.varsPRM[40][0], 0], 
                    [FLAM3VARS.varsPRM[41][0], 0], 
                    [FLAM3VARS.varsPRM[42][0], 0], 
                    ...
                    [FLAM3VARS.varsPRM[45][0], 0], 
                    [FLAM3VARS.varsPRM[46][0], 0], 
                    [FLAM3VARS.varsPRM[47][0], [prx_FP + FLAM3VARS.varsPRM[47][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[48][0], [prx_FP + FLAM3VARS.varsPRM[48][1][0][:-1], 1], [prx_FP + FLAM3VARS.varsPRM[48][2][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[49][0], [prx_FP + FLAM3VARS.varsPRM[49][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[50][0], [prx_FP + FLAM3VARS.varsPRM[50][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[51][0], [prx_FP + FLAM3VARS.varsPRM[51][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[52][0], [prx_FP + FLAM3VARS.varsPRM[52][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[53][0], [prx_FP + FLAM3VARS.varsPRM[53][1][0][:-1], 0], 1],
                    [FLAM3VARS.varsPRM[54][0], 0],
                    [FLAM3VARS.varsPRM[55][0], 0], 
                    [FLAM3VARS.varsPRM[56][0], [prx_FP + FLAM3VARS.varsPRM[56][1][0][:-1], 0], 1], 
                    [FLAM3VARS.varsPRM[57][0], [prx_FP + FLAM3VARS.varsPRM[57][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[58][0], 0], 
                    [FLAM3VARS.varsPRM[59][0], 0], 
                    [FLAM3VARS.varsPRM[60][0], 0], 
                    [FLAM3VARS.varsPRM[61][0], [prx_FP + FLAM3VARS.varsPRM[61][1][0][:-1], 0], 1], 
                    [FLAM3VARS.varsPRM[62][0], 0], 
                    [FLAM3VARS.varsPRM[63][0], [prx_FP + FLAM3VARS.varsPRM[63][1][0][:-1], 1], [prx_FP + FLAM3VARS.varsPRM[63][2][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[64][0], 0], 
                    [FLAM3VARS.varsPRM[65][0], 0], 
                    [FLAM3VARS.varsPRM[66][0], [prx_FP + FLAM3VARS.varsPRM[66][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[67][0], [prx_FP + FLAM3VARS.varsPRM[67][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[68][0], 0], 
                    [FLAM3VARS.varsPRM[69][0], [prx_FP + FLAM3VARS.varsPRM[69][1][0][:-1], 1], [prx_FP + FLAM3VARS.varsPRM[69][2][0][:-1], 0], 1], 
                    [FLAM3VARS.varsPRM[70][0], 0], 
                    [FLAM3VARS.varsPRM[71][0], [prx_FP + FLAM3VARS.varsPRM[71][1][0][:-1], 1], [prx_FP + FLAM3VARS.varsPRM[71][2][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[72][0], [prx_FP + FLAM3VARS.varsPRM[72][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[73][0], [prx_FP + FLAM3VARS.varsPRM[73][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[74][0], [prx_FP + FLAM3VARS.varsPRM[74][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[75][0], [prx_FP + FLAM3VARS.varsPRM[75][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[76][0], [prx_FP + FLAM3VARS.varsPRM[76][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[77][0], [prx_FP + FLAM3VARS.varsPRM[77][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[78][0], [prx_FP + FLAM3VARS.varsPRM[78][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[79][0], [prx_FP + FLAM3VARS.varsPRM[79][1][0][:-1], 1], [prx_FP + FLAM3VARS.varsPRM[79][2][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[80][0], 0], 
                    [FLAM3VARS.varsPRM[81][0], 0], 
                    [FLAM3VARS.varsPRM[82][0], 0], 
                    [FLAM3VARS.varsPRM[83][0], 0], 
                    ...
                    [FLAM3VARS.varsPRM[92][0], 0], 
                    [FLAM3VARS.varsPRM[93][0], 0], 
                    [FLAM3VARS.varsPRM[94][0], [prx_FP + FLAM3VARS.varsPRM[94][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[95][0], [prx_FP + FLAM3VARS.varsPRM[95][1][0][:-1], 0], 1], 
                    [FLAM3VARS.varsPRM[96][0], [prx_FP + FLAM3VARS.varsPRM[96][1][0][:-1], 1], [prx_FP + FLAM3VARS.varsPRM[96][2][0][:-1], 1], 1],
                    [FLAM3VARS.varsPRM[97][0], [prx_FP + FLAM3VARS.varsPRM[97][1][0][:-1], 1], [prx_FP + FLAM3VARS.varsPRM[97][2][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[98][0], [prx_FP + FLAM3VARS.varsPRM[98][1][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[99][0], [prx_FP + FLAM3VARS.varsPRM[99][1][0][:-1], 1], [prx_FP + FLAM3VARS.varsPRM[99][2][0][:-1], 1], 1], 
                    [FLAM3VARS.varsPRM[100][0], 0], 
                    [FLAM3VARS.varsPRM[101][0], [prx_FP + FLAM3VARS.varsPRM[101][1][0][:-1], 1], [prx_FP + FLAM3VARS.varsPRM[101][2][0][:-1], 1], [prx_FP + FLAM3VARS.varsPRM[101][3][0][:-1], 1], 1] )
