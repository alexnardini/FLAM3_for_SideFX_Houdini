...
- **New H22 UP ONLY**: Parametric variations parameters now have proper UI tooltips with descriptions of what each parameter's component does. Using the new `html` syntax feature makes all the toostips a pleasure to write and add!
