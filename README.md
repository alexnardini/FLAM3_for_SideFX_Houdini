...
| :--- | :--- | :--- | :--- |
| **ALU Core Math** | `FMA`, `FMUL`, `FADD` | **15,962** | Floating-point arithmetic operations. |
...
| **LOP3.LUT instructions** | `LOP3.LUT` | **2712** | 3-input programmable bitwise logic instructions. |
