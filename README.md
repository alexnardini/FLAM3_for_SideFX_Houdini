...
Python run single threaded here, therefore when a lot of iterators are created, Houdini's user interface becomes a little slow.
I think I did make every effort to make it better, with no success. I used 128+ iterators in all of my tests, even tho I actually never went over 20 for any of the fractal flames images I've made so far, most of them were less than 10 iterators. A computer processor with good single-threaded performance would be very helpful here.
...
_All images and logos copyright © Alessandro Nardini 2020-2023 and their other respective owners._
